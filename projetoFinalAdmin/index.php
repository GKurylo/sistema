...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul>
                        ...
                        <li>Por fim se você quiser clique em (Observação) para adicionar uma observação e/ou em (Salvar
                            Agendamentos) para salvar o agendamento.</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="content-body" style="min-height: 899px;">
        <div class="container-fluid">
            <div class="card p-2">
                <div class="text-center fs-xs-5">
                    <h3>SISTEMA DE AGENDAMENTOS</h3>
                </div>
                <div class="text-center">
                    <div id="calendar"
                        style="width:100%;max-height:700px;overflow-x: auto; -webkit-overflow-scrolling: touch;"></div>
                </div>
                ...
                <div class="modal fade" id="modalObservacao" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" id="btnSalvarObservacao" class="btn btn-primary">Salvar
                                    Observação</button>
                            </div>
                        </div>
                    </div>
